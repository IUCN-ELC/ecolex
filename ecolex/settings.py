...
DOC_URL = os.environ.get('DOC_URL', 'https://faolex.fao.org/docs/texts/')
HTML_URL = os.environ.get('HTML_URL', 'https://faolex.fao.org/docs/html/')
PDF_URL = os.environ.get('PDF_URL', 'https://faolex.fao.org/docs/pdf/')
...
SOLR_IMPORT = {
    'common': {
        ...
        'fao_regions_json': os.path.join(CONFIG_DIR, 'fao_regions.json'),
        'subdivisions_json': os.path.join(CONFIG_DIR, 'subdivisions.json'),
        'keywords_json': os.path.join(CONFIG_DIR, 'keywords.json'),
        'fao_keywords_xml': os.path.join(CONFIG_DIR, 'fao_keywords.xml'),
        'informea_keywords_json': os.path.join(CONFIG_DIR, 'informea_ecolex_json.json'),
        'subjects_json': os.path.join(CONFIG_DIR, 'subjects.json'),
        'fao_subjects_xml': os.path.join(CONFIG_DIR, 'fao_subjects.xml'),
