...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            compileCore: {
                options: {
                    ...
                    sourceMapFilename: '../css/<%= pkg.name %>.custom.css.map'
                },
                src: 'less/bootstrap.less',
                dest: '../css/<%= pkg.name %>.custom.css'
            }
        },
        ...
        cssmin: {
            ...
            minifyCore: {
                src: '../css/<%= pkg.name %>.custom.css',
                dest: '../css/<%= pkg.name %>.custom.min.css'
            }
        },
        ...
        usebanner: {
            ...
            files: {
                src: ['../css/<%= pkg.name %>.custom.css', '../css/<%= pkg.name %>.custom.min.css']
            }
        },
    ...
    // Default task.
    grunt.registerTask('default', ['copy:fonts', 'test']);
