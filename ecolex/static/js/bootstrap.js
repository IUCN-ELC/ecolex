    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><input class="form-control multiselect-search" type="search"></li>',
                filterClearBtn: '<span></span>', // '<span class="input-group-btn"><button class="btn btn-default multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button></span>',
        ...
        buildDropdownOptions: function() {
            ...
            this.$container.off('keydown.multiselect').on('keydown.multiselect', $.proxy(function(event) {
                if ($('input[type="search"]', this.$container).is(':focus')) {
                    return;
                }
    ...
    privateMethods = {
        ...
        init : function (options) {
            ...
            this.each(function() {
                ...
                if (opts.tagsContainer) {
                    $self.before(opts.tagsContainer);
                }
