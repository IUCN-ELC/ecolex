...
SOLR_FIELDS = [
    ...
    'litLongTitle_en', 'litLongTitle_fr', 'litLongTitle_sp', 'litLongTitle_other',
    'litPaperTitleOfText_en', 'litPaperTitleOfText_fr', 'litPaperTitleOfText_sp', 'litPaperTitleOfText_other',
    'litSerialTitle', 'litId',
    'litTitleOfTextShort_en', 'litTitleOfTextShort_fr', 'litTitleOfTextShort_sp',
    ...
    'litCountry', 'litRegion', 'litSubject_en', 'litLanguageOfDocument',
